  ...
  serviceSummaries: [
    {
      ...
      description: '¿Necesitas desocupar una vivienda en {{city}}? Ofrecemos un vaciado integral y eficiente de pisos y apartamentos en toda la provincia, liberando el inmueble para una nueva etapa con rapidez y discreción.',
    ...
    },
    {
      ...
      description: 'Vaciado profesional de locales comerciales en toda la zona del Tarragonès y el Baix Ebre. Desocupamos oficinas, tiendas y almacenes para reformas, alquiler o traspaso con la máxima eficiencia.',
    ...
    },
    {
      ...
      description: 'Retiramos muebles usados a domicilio en {{city}} y municipios cercanos. Servicio rápido, económico y responsable: clasificamos los objetos para su reutilización, donación o reciclaje correctos.',
    ...
    },
    {
      ...
      description: 'Equipo especializado en la recuperación de viviendas afectadas por el síndrome de Diógenes en {{city}} y provincia. Actuamos con total confidencialidad, respetando la dignidad del afectado.',
    ...
    },
    {
      ...
      description: 'Después de cualquier vaciado, tu propiedad merece quedar impecable. Realizamos limpiezas a fondo en {{city}} y comarca, eliminando suciedad, manchas persistentes y olores para dejar el inmueble listo.',
